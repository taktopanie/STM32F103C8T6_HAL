...
void MOTOR_set_position_CD (uint8_t pos)
{
	...
	{
		case 0:
			HAL_GPIO_WritePin(MOTOR_PORT_0_CD, MOTOR_PIN_0_CD, ENABLE);
			HAL_GPIO_WritePin(MOTOR_PORT_1_CD, MOTOR_PIN_1_CD, DISABLE);
			HAL_GPIO_WritePin(MOTOR_PORT_2_CD, MOTOR_PIN_2_CD, DISABLE);
			HAL_GPIO_WritePin(MOTOR_PORT_3_CD, MOTOR_PIN_3_CD, DISABLE);
			break;
		case 1:
		{
			HAL_GPIO_WritePin(MOTOR_PORT_0_CD, MOTOR_PIN_0_CD, DISABLE);
			HAL_GPIO_WritePin(MOTOR_PORT_1_CD, MOTOR_PIN_1_CD, DISABLE);
			HAL_GPIO_WritePin(MOTOR_PORT_2_CD, MOTOR_PIN_2_CD, ENABLE);
			HAL_GPIO_WritePin(MOTOR_PORT_3_CD, MOTOR_PIN_3_CD, DISABLE);
			break;
		}
		case 2:
		{
			HAL_GPIO_WritePin(MOTOR_PORT_0_CD, MOTOR_PIN_0_CD, DISABLE);
			HAL_GPIO_WritePin(MOTOR_PORT_1_CD, MOTOR_PIN_1_CD, ENABLE);
			HAL_GPIO_WritePin(MOTOR_PORT_2_CD, MOTOR_PIN_2_CD, DISABLE);
			HAL_GPIO_WritePin(MOTOR_PORT_3_CD, MOTOR_PIN_3_CD, DISABLE);
			break;
		}
		case 3:
		{
			...
			HAL_GPIO_WritePin(MOTOR_PORT_1_CD, MOTOR_PIN_1_CD, DISABLE);
			HAL_GPIO_WritePin(MOTOR_PORT_2_CD, MOTOR_PIN_2_CD, DISABLE);
			HAL_GPIO_WritePin(MOTOR_PORT_3_CD, MOTOR_PIN_3_CD, ENABLE);
			break;
		}
		case 99:
		{
